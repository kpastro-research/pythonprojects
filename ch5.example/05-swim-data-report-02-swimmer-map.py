...
def get_swimmer_data_map(all_swimmer_data):
   print(get_unique_swimmer_data(all_swimmer_data))


all_swimclub_data=swimclub_dict.get_swim_data_dict(SWIM_DATA_FOLDER, 0,400,SWIM_DATA_FOLDER)
get_swimmer_data_map(all_swimclub_data)
#
#
#
#
